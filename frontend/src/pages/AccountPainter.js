...
const AccountPainter = () => {
    ...
    // const handleSaveDetails = async () => {
    //     try {
    //         const response = await axios.put(`http://localhost:8000/api/edit_user_details/`, painterDetails, {
    //             headers: {
    //                 Authorization: `Token ${localStorage.getItem('token')}`
    //             }
    //         });
...
//         try {
//             const data = new FormData();
//             data.append('name_picture', formData.name_picture);
//             data.append('name_painter', formData.name_painter);
//             data.append('image', formData.image);
//             data.append('aboutPainter', formData.aboutPainter);
...
//             genre: pictureToEdit.genre,
//             price: pictureToEdit.price,
//             aboutPainter: pictureToEdit.aboutPainter,
//             workExperience: pictureToEdit.workExperience,
//             education: pictureToEdit.education
//         });
//         setEditId(id);
//     };
...
//     return (
//         <div className="container">
//             <img src={oymo} alt="Oymo" className="picture-img" />
//             <div className="row">
//                 <div className="col-md-6">
//                     <div className="account-painter-section">
...
//                                 </div>
//                                 <div className="form-group">
//                                     <input type="text" name="name" value={formData.name_painter} className="form-control" placeholder="Name" onChange={handleChange} /> 
//                                 </div>
//                                 <div className="form-group">
//                                     <textarea name="aboutPainter" value={formData.aboutPainter} className="form-control" placeholder="About Painter" onChange={handleChange}></textarea>
//                                 </div>
//                                 <div className="form-group">
//                                     <textarea name="workExperience" value={formData.workExperience} className="form-control" placeholder="Work Experience" onChange={handleChange}></textarea>
//                                 </div>
//                                 <div className="form-group">
//                                     <textarea name="education" value={formData.education} className="form-control" placeholder="Education" onChange={handleChange}></textarea>
//                                 </div>
//                             </form>
//                         </div>
//                     </div>
...
//                             <form onSubmit={handleSubmit}>
//                                 <div className="form-group">
//                                     <input type="text" name="name" value={formData.name_picture} className="form-control" placeholder="Name" onChange={handleChange} />
//                                 </div>
//                                 <div className="form-group">
//                                     <input type="file" name="image" className="form-control-file" onChange={handleImageChange} />
//                                 </div>
